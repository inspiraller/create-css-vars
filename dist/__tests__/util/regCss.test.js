'use strict';var __awaiter=this&&this.__awaiter||function(thisArg,_arguments,P,generator){function adopt(value){return value instanceof P?value:new P(function(resolve){resolve(value);});}return new(P||(P=Promise))(function(resolve,reject){function fulfilled(value){try{step(generator.next(value));}catch(e){reject(e);}}function rejected(value){try{step(generator['throw'](value));}catch(e){reject(e);}}function step(result){result.done?resolve(result.value):adopt(result.value).then(fulfilled,rejected);}step((generator=generator.apply(thisArg,_arguments||[])).next());});};Object.defineProperty(exports,'__esModule',{value:true});const regCss_1=require('..\\..\\src\\util\\regCss');describe('regCss',()=>{describe('regTruncate',()=>{it('should clean  ',()=>__awaiter(void 0,void 0,void 0,function*(){const str=' john  ';const actual=str.replace(regCss_1.regTruncate,'');const result='john';expect(actual).toBe(result);}));});describe('regCombined',()=>{describe('success',()=>{it('should match 2 combined selectors  ',()=>__awaiter(void 0,void 0,void 0,function*(){const strSelector=`selector1,selector2 {
          position: absolute;
