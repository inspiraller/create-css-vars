'use strict';var __importDefault=this&&this.__importDefault||function(mod){return mod&&mod.__esModule?mod:{'default':mod};};Object.defineProperty(exports,'__esModule',{value:true});const popWithChildCss_1=__importDefault(require('..\\..\\src\\popCss\\popSeparateCombined\\popWithChildCss'));const crop_1=__importDefault(require('..\\..\\src\\util\\crop'));describe('popWithChildCss',()=>{describe('success',()=>{it('should construct - 1 child',()=>{const objCss={'.link elem':['color: red;']};const strSingleSelector='.link';const actual=popWithChildCss_1.default({strSingleSelector,objCss});const expected=`
        & elem {
          color: red;
        }
