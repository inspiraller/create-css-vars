'use strict';var __importDefault=this&&this.__importDefault||function(mod){return mod&&mod.__esModule?mod:{'default':mod};};Object.defineProperty(exports,'__esModule',{value:true});const popMediaQCss_1=__importDefault(require('../../popCss/popMediaQCss'));const crop_1=__importDefault(require('../../util/crop'));const clearCssComents_1=__importDefault(require('../../util/clearCssComents'));describe('popWMediaQCss',()=>{describe('success',()=>{it('should construct - MediaQuery - of single',()=>{const objCss={'@media()':{single:{'.link':['color: red;']}}};const strSingleSelector='.link';const actual=popMediaQCss_1.default({strSingleSelector,objCss});const expected=`
        @media() {
          color: red;
        }
