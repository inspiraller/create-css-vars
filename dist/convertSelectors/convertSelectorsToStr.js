'use strict';Object.defineProperty(exports,'__esModule',{value:true});exports.convertObjStrToStr=void 0;const convertObjStrToStr=selectors=>Object.keys(selectors).reduce((accum,cur)=>`${accum}  '${cur}': getTheme => \`${selectors[cur]}\`,\n`,'');exports.convertObjStrToStr=convertObjStrToStr;const convertSelectorsToStr=selectors=>{return`
